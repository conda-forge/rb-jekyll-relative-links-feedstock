About rb-jekyll-relative-links
==============================
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7656&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rb-jekyll-relative-links-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rb-jekyll-relative-links` can be installed with:

```
conda install rb-jekyll-relative-links
```

It is possible to list all of the versions of `rb-jekyll-relative-links` available on your platform with:
